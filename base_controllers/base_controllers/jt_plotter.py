...
class JointTrajectoryPublisher(Node):
    ...
    def update_plot(self):
        ...
        for i, joint in enumerate(self.trajectory.joint_names):
            ...
            # Plot the target joint positions as discrete points in red
            if len(self.target_time_data) > 0:  # Ensure there are target times to plot
    ...
    def publish_trajectory(self):
        if self.current_point < len(self.trajectory_points):
            ...
            target_point = self.trajectory_points[self.current_point]
